...
public class DesertPyramidFinder extends AbstractTempleFinder {
    ...
    public void buildStructure(PieceFinder finder) {
        BlockState blockState_1 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairsBlock.FACING, Direction.NORTH);
        BlockState blockState_2 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairsBlock.FACING, Direction.SOUTH);
        BlockState blockState_3 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairsBlock.FACING, Direction.EAST);
        BlockState blockState_4 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairsBlock.FACING, Direction.WEST);
